				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="./img/limpieza/ldt2.png" alt="">
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">Limpiador de tapicerías velour sq</h2>
							<div>
							...
							<p>Diseñado para garantizar la limpieza eficaz y proteger la apariencia lujosa que caracteriza los interiores de los vehículos actuales. La espuma super seca de "VELOUR" elimina todo tipo de manchas y sucios, mientras que sus siliconas especiales demoran la acumulación de nuevo sucio.</p>
							...
							<ul class="product-btns">
								<li><a href="index.php"><i class="fa fa-heart-o"></i> ECOCHIVERA</a></li>
